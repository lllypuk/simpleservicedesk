// Package interfaces defines repository interfaces and shared structures
// for data access layer abstraction across the application.
//
//nolint:revive // interfaces is a meaningful package name in this context
package interfaces
